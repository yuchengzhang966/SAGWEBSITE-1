    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 mx-auto text-center">
                <span class="badge bg-accent text-white mb-3">STUDY PLAN</span>
                <h1 class="display-4 fw-bold mb-3">GMAT 8-Week Study Plan</h1>
                <p class="lead mb-4">A structured approach to maximize your GMAT score in 8 weeks</p>
                <div class="d-flex justify-content-center align-items-center small text-white-50">
                    <div class="me-3">
                        <i class="bi bi-clock me-1"></i> Last updated: September 2023
                    </div>
                    <div>
